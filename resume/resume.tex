...
\newfontfamily\futuramedium{Futura-Medium.ttf}[Path = /usr/local/share/fonts/TTF/]
\newcommand{\medium}[1]{
  {\futuramedium#1}
}
...
\begin{document}
  ...
  \topic{Skills} {
    \medium{Programming Languages:}C/C++, AVR Assembly, Python, HTML, CSS, Typescript/Javascript, LaTeX \newline
  ...
  \topic{Projects} {
    ...
    \entry{2D Physics Emulator \linknf{}{https://github.com/MusicalArtist12/2d-vector}}{C++, OpenGL/GLFW/GLM/ImGUI}{Aug 2023 - Present} {
      \begin{itemize}
        \item Developing an application that emulates physics in a 2D environemnt
        \item Developing various detection methods to implement collision detection, movement, air pressure, and energy
      \end{itemize}
    }
  }
