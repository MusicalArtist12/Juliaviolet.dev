...
\begin{document}
  ...
  \topic{Skills} {
    ...
    \medium{Tools/Frameworks:}Linux(CLI, Arch Linux incl. AUR), OpenGL/GLFW/GLM, ImGUI, React/Next.JS, VS Code\newline
    \medium{Interests:}Linux Development, Low-level/Assembly Programming, Graphics Programming
  }
  \topic{Projects} {
